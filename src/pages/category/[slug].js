export const Beauty = () => (
    <>
      ...
      <link
        ...
        media="all"
      />
      <title>Fashion &amp; Style | FlexiBlog Theme</title>
      <meta
      ...
      <meta itemProp="name" content="Fashion & Style" data-react-helmet="true" />
      <meta
      ...
      <div id="___gatsby">
        <div tabIndex={-1} id="gatsby-focus-wrapper" style={{ outline: "none" }}>
          <div className="css-130izn8">
            <div className="css-8quyoq">
              <div className="css-1s3ligh">
                <div className="css-16oqm0b">
                  <div className="css-1q5edj3">
                    <a
                      alt="FlexiBlog Theme"
                      aria-label="FlexiBlog Theme"
                      className="css-7muaid"
                      href="/"
                    >
                      <div
                      ...
                      >
                        <div style={{ maxWidth: 150, display: "block" }}>
                          <img
                            alt=""
                            role="presentation"
                            aria-hidden="true"
                            src="data:image/svg+xml;charset=utf-8,%3Csvg%20height='35'%20width='150'%20xmlns='http://www.w3.org/2000/svg'%20version='1.1'%3E%3C/svg%3E"
                            style={{
                              maxWidth: "100%",
                              display: "block",
                              position: "static"
                        ...
                        <picture>
                          <source
                            type="image/webp"
                            srcSet="/static/e1abc27a01b56d93f5fcdff62c84fdd7/67108/logo.webp 38w,
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/38397/logo.webp 75w,
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/edeef/logo.webp 150w,
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/d7151/logo.webp 300w"
                          ...
                          <img
                            ...
                            srcSet="/static/e1abc27a01b56d93f5fcdff62c84fdd7/6e6b3/logo.png 38w,
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/7e8ff/logo.png 75w,
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/a15e9/logo.png 150w,
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/a05b5/logo.png 300w"
                            alt="FlexiBlog Theme"
                          />
                        </picture>
                        <noscript>
                          ...
                          sizes="(min-width: 150px) 150px, 100vw" decoding="async"
                          loading="eager"
                          src="/static/e1abc27a01b56d93f5fcdff62c84fdd7/a15e9/logo.png"
                  ...
                  <div className="css-163yhbe" />
                  <div className="css-td4tiv">
                    <div className="css-mzyruo">
                      <div className="css-yo0yuz">
                        <a className="css-f5zorj" href="/">
                          Home
                        </a>
                        <a className="css-f5zorj" href="/authors/">
                          Our Team
                        </a>
                        <a className="css-f5zorj" href="/contact/">
                          Contact
                        </a>
                      </div>
                    </div>
                    <div className="css-13pi9m9">
                      <button aria-label="Menu" className="css-1xw2bw6">
                        <svg
                          stroke="currentColor"
                          fill="currentColor"
                          strokeWidth={0}
                      ...
                      <div className="css-ifm721">
                        <div className="css-kovx41" />
                      </div>
                      <div className="css-1ylv1n" />
                    </div>
                  </div>
                    ...
                    <div className="css-4cffwv">
                      <div>
                        <h1 className="css-1lquv60">
                          Fashion &amp; Style{" "}
                          <div className="css-z6qugz"> 10</div>
                        </h1>
  ...
  /static/a381cbe123484c239b97a005d5ce4a00/144fe/image.jpg 380w"
                                ...
                                <div className="css-1gtzvof">
                                  ...
                                  <div className="css-q1n9x1">
                                    Lorem markdownum quisque caeli, aura niger
                                    molitur tangam licebit, cum quo ut harenae
                                    pauper, eras…
                                  </div>
                                  <div className="css-xua87t-CardFooter">
                                    <a
  ...
  /static/a381cbe123484c239b97a005d5ce4a00/144fe/image.jpg 380w"
                                ...
                                <div className="css-1gtzvof">
                                  ...
                                  <div className="css-q1n9x1">
                                    Lorem markdownum obvius in seque opus, est
                                    bicorni forte; laeva. Iurant patria beatam
                                    semel…
                                  </div>
                                  <div className="css-xua87t-CardFooter">
                                    <a
  ...
  /static/a381cbe123484c239b97a005d5ce4a00/144fe/image.jpg 380w"
                                ...
                                <div className="css-1gtzvof">
                                  ...
                                  <div className="css-q1n9x1">
                                    Nec ego a vidit Lorem markdownum Ilion. Naides
                                    ferox vocantem, Iuno artes patrios tamen,
                                    spicea…
                                  </div>
                                  <div className="css-xua87t-CardFooter">
                                    <a
  ...
  /static/ec552a7c1f96030de0601b3b204b16cf/416a0/jane-smith.png 96w"
            ...
            <div className="css-3flha1">
              <div className="css-12o0vr3">
                <div className="css-q7bxia">
                  <div className="css-vurnku">
                    <div className="css-10xguhx">
                      <a
                        alt="FlexiBlog Theme"
                        aria-label="FlexiBlog Theme"
                        className="css-7muaid"
  ...
  /static/e1abc27a01b56d93f5fcdff62c84fdd7/a05b5/logo.png 300w"
                  ...
                  <div className="css-vurnku">
                    <p className="css-kiprn0">Quick Links</p>
                    <div className="css-j4toqg">
                      <a className="css-18f2uil" href="/contact/">
                        Advertise with us
                      </a>
                      <a className="css-18f2uil" href="/about/">
                        About Us
                      </a>
                      <a className="css-18f2uil" href="/contact/">
                        Contact Us
                  ...
                  <div className="css-vurnku">
                    <p className="css-kiprn0">Legal Stuff</p>
                    <div className="css-j4toqg">
                      <a className="css-18f2uil" href="/">
                        Privacy Notice
                      </a>
                      <a className="css-18f2uil" href="/">
                        Cookie Policy
                  ...
                  <div className="css-vurnku">
                    <p className="css-kiprn0">Social Media</p>
                    <div className="css-1ewyfna">
                      <a
                        href="https://github.com/gatsbyjs"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="css-18f2uil"
                      >
                        <svg
                          stroke="currentColor"
                          fill="currentColor"
        ...
        >
          Navigated to Fashion &amp; Style 10
        </div>
      </div>
      <div id="loom-companion-mv3" ext-id="liecbddmkiiihnedobmlmillhodjkdmb">
        <section id="shadow-host-companion" />
      </div>
      <div id="query-on-demand-indicator-element" />
      <gatsby-qod />
    </>
  )
