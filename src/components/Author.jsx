  ...
  return (
    ...
    <div className="css-h0h0h8">
      ...
      <div className="css-ml7o7s">
        ...
        <div className="css-h0h0h8">
          <div className="css-1edag21">
            <div className="css-1izuu00">
              <h2 className="css-1c1ar45">
                Wedding Planner
              </h2>
              <div className="css-vurnku">
                Sed commodo, est quis maximus fermentum,
                massa ipsum euismod neque, in varius risus
                tellus quis lacus. Sed ac bibendum odio.
              </div>
            </div>
          </div>
          <div className="css-1edag21">
            <div className="css-4cffwv">
              <div className="css-1edag21">
                <h2 className="css-1c1ar45">Expertise</h2>
                <div className="css-vurnku">
                  Wedding Planning
                </div>
                <div className="css-vurnku">
              ...
              <div className="css-1edag21">
                ...
                <div className="css-umxmuk">
                  <a
                    href="https://instagram.com/instagram"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="css-1xogqwt"
                  >
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
